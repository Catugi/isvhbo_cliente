...
// Generate Order Data
function createData(id, date, name, cameFrom, serviceType,paymentMethod, amount) {
  return { id, date, name, cameFrom, serviceType, paymentMethod, amount };
}

const rows = [
  createData(
    1,"20 de, Março, 2020", "Jhon Doe",
    'Bié', 'Aluguer de Quarto', 'TPA', 25000.00
...
export default function Orders() {
  return (
    <React.Fragment>
      <Title>Clientes Recente a seus eventos</Title>
      <Table size="small">
        <TableHead>
          <TableRow>
